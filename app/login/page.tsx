...
import { RefreshCw, AlertCircle, Eye, EyeOff, Mail, Lock, CheckCircle2 } from 'lucide-react';
        ...
        <div className="max-w-[1100px] w-full bg-white rounded-[2rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] overflow-hidden flex flex-col md:flex-row min-h-[650px]">
          ...
          <div className="flex-1 p-8 sm:p-12 lg:p-16 flex flex-col justify-center bg-white">
            ...
            <div className="bg-slate-100 p-1 rounded-full flex items-center max-w-[240px] mx-auto md:mx-0 mb-10 border border-slate-200/60 shadow-sm">
              <Link href="/login" className="flex-1 text-center py-2 text-xs font-bold rounded-full bg-white text-blue-600 shadow-sm transition-all">
                Login
              </Link>
              <Link href="/signup" className="flex-1 text-center py-2 text-xs font-bold rounded-full text-slate-500 hover:text-slate-700 transition-all">
                Sign Up
              </Link>
            </div>
            ...
            <div className="space-y-2 mb-8 text-center md:text-left">
              ...
              <p className="text-slate-500 text-sm">Please enter your details to continue your learning.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 bg-[#004ce6] disabled:opacity-50 hover:bg-[#003bb3] text-white rounded-xl text-sm font-semibold transition-all flex items-center justify-center gap-2 mt-2"
              >
                {loading ? (
                  <>
            ...
            <div className="mt-8 text-center text-xs font-medium text-slate-500">
              ...
              <Link href="/signup" className="text-[#004ce6] hover:underline font-bold">
                Join Learn-Sphere
              </Link>
            </div>
          </div>
